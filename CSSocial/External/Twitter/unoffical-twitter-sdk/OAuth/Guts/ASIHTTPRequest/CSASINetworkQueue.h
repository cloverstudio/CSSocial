...
#import "CSASIHTTPRequestDelegate.h"
#import "CSASIProgressDelegate.h"

@interface CSASINetworkQueue : NSOperationQueue <CSASIProgressDelegate, CSASIHTTPRequestDelegate, NSCopying> {
...
// All CSASINetworkQueues are paused when created so that total size can be calculated before the queue starts
